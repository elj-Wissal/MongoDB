...
const arrayOfPeople = [
  { name: 'Fatima', age: 23, favoriteFoods: ['couscous', 'briwa'] },
  { name: 'Mouna', age: 26, favoriteFoods: ['shawarma', 'pizz 4 saison'] },
  { name: 'Fatimzahre', age: 30, favoriteFoods: ['spaghetti', 'rfisa'] }
];
